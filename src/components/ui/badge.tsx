  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        info: "border-transparent bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-300",
        premium: "border-transparent bg-gradient-to-r from-gray-600 to-slate-700 text-white",
